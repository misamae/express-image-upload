...
export class ProjectConfig extends SeedConfig {
  ...
  constructor() {
    super();
    this.APP_TITLE = 'Images';

    /* Enable typeless compiler runs (faster) between typed compiler runs. */
    // this.TYPED_COMPILE_INTERVAL = 5;

    this.SYSTEM_CONFIG_DEV.paths['ng2-file-upload'] = `${this.APP_BASE}node_modules/ng2-file-upload/index.js`;

    this.SYSTEM_BUILDER_CONFIG.packages['ng2-file-upload'] = {
      main: 'bundles/ng2-file-upload.umd.min.js',
      defaultExtension: 'js'
    };
